...
# ================= START GAME ================= #
def start_game():
    global secret_number, lives, score, hints, game_started

    # Prevent restarting using Start button
    if game_started:
        result.config(
            text="⚠️ Game already started! Use Restart button.",
            fg="orange"
        )
        return
...
# ================= CHECK GUESS ================= #
def check_guess():
    global lives, score, game_started
